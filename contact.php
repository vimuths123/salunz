...
if (isset($_POST['email'])) {
    ...
    if ($_POST['time'] == "") {
        ...
        $result = $conn->query("SELECT * 
             FROM `booking` 
             WHERE `booking_time` = '" . substr($_POST['time'], 11) . "'
             AND `booking_date` = '" . substr($_POST['time'], 0, 10) . "'");
...
//             }
//         }
//        echo getenv('HTTP_X_FORWARDED_FOR'); //ip
//        echo substr($_POST['time'],11); //time
//        echo substr($_POST['time'],0,10); //date
//        exit();


        $conn->query("INSERT INTO `booking` (`name`,`email`,`phone`,`booking_time`,`comment`,`booking_date`,`user_ip`) VALUES ('" . $_POST['name'] . "','" . $_POST['email'] . "','" . $_POST['phone'] . "','" . substr($_POST['time'], 11) . "','" . $_POST['comment'] . "','" . substr($_POST['time'], 0, 10) . "','" . $_SERVER['REMOTE_ADDR'] . "')");
    }
